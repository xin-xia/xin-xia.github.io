...
<strong>Journal Papers (120)</strong>: IEEE Transactions on Software Engineering * 37, Empirical Software Engineering * 22,  ACM Transactions on Software Engineering and Methodology * 23, ACM Computing Surveys * 2, IEEE  Transactions on Dependable and Secure Computing * 1, IEEE Transactions on Service Computing * 1. 
...
117. Zhuo Zhang, Yan Lei, Xiaoguang Mao, Meng Yan, , David Lo. Context-Aware Neural Fault Localization.  Multi-Granularity Detector for Vulnerability Fixes. IEEE Transactions on Software Engineering (TSE), Accepted.         <br />     
